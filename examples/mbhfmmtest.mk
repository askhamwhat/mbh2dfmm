PROJECT=MBHFMMTEST  # for historical reasons we always like to 
...
.SUFFIXES: $(MODSUF) .$(OBJSUF) .f .f90 .c
...
F90SRCS = mbhfmmtest_dr.f90

FSRCS = lrtree2d.f \
	mbhrouts2d.f modbhrouts.f mbhfmm2d.f\
	yukrouts2d.f helmrouts2d.f prini.f hkrand.f dlaran.f \
	hank103.f cdjseval2d.f dfft.f
#	mbhfmm2d.f
